...
public final class Job {
  ...
  public void publish() {
    if (status != JobStatus.DRAFT)
      throw new BusinessException("Only draft job can be published");
  ...
  public void expire() {
    if (status != JobStatus.PUBLISHED)
      throw new BusinessException("Only published job can expire");

    if (!deadline.isExpired())
      throw new BusinessException("Job deadline has not been reached");
