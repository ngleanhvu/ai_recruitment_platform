...
public record JobRest(
    CreateJobUseCase createJobUseCase, UpdateJobInformationUseCase updateJobInformationUseCase) {
  @PostMapping("/create")
  ...
  public ApiResponse<Void> updateJobInformation(
      @RequestBody CreateJobRequest request, @PathVariable("jobId") String jobId) {
