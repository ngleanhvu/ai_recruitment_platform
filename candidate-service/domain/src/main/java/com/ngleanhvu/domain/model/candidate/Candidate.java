...
public final class Candidate {
    ...
    public void updateSummary(String summary) {
        if (ValidationUtil.isEmpty(summary))
    ...
    public void addExperience(Experience experience) {
        if (ValidationUtil.isNull(experience))
            throw new DomainException("Experience required");
    ...
    public void block() {
        if (status == CandidateStatus.BLOCKED)
            throw new DomainException("Candidate already blocked");
