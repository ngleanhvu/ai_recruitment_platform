...
public class ResumeGrpc extends ResumeServiceGrpc.ResumeServiceImplBase {
  ...
  @Override
  public void existsResumeByIdAndCandidateId(
      ExistsResumeByIdAndCandidateIdRequest request,
      StreamObserver<ExistsResumeByIdAndCandidateIdResponse> responseObserver) {
    ...
    ExistsResumeByIdAndCandidateIdResponse response =
        ExistsResumeByIdAndCandidateIdResponse.newBuilder().setExists(existsResume).build();
